<div>
                    ...
                    <div class="card-body" style="font-size: 13px;">
                        <div class="table-responsive">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                $idPaciente = $item->id;
                                @endphp
                                <input type="hidden" value="{{ $item->id }}" id="paciente_id" wire.model="paciente_id">
    ...
    <section class="content container-fluid">
        <div class="card card-warning">
            <div class="card-header">
                ...
                <label><i class="fas fa-syringe"></i> VACUNAS
                </label>
                        ...
                        <table class="table table-sm table-hover table-bordered" id="tb_tratamiento">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><button class="btn btn-sm btn-warning" title="Eliminar"
    ...
    <script>
        function addTratamiento() {
            ...
            function cargaDatos() {
                mostrarLoading();
                @this.set('anamnesis', '01-Vacunacion');
                ...
                if (filas <= 0) {
                    Swal.fire(
                        'Atencion!',
                        'Debe agregar al menos una vacuna en el registro',
                        'warning'
                    )
                    ocultarLoading();
                }
